<template>
  <div class="media_qc_center" ref="qc_center">
    <div v-if="showFilter">
      <ul class="qc_top">
        <li>
    ...
    <div v-else class="qc_audit">
      ...
      <el-row class="qc_audit_main">
        <el-col :span="4" v-for="(item, index) in qcList" :key="index">
          <MediaQCBox
            :ref="`qcAudit${item.id}`"
            :auditData="item"
...
import MediaQCBox from '@/components/media_audit_box/MediaQCBox.vue'

...
const serverURL = new Map([
  ['development', 'http://waf-xmhg.fosuss.com:8082/'],
  ['testbuild', 'http://waf-xmhg.fosuss.com:8082/'],
  ['production', 'http://waf-xmhg.fosuss.com:8082/'],
])
...
// upload
export const UPLOAD_URL = `http://waf-xmhg.fosuss.com:8082/`
